...
!(function (t, r) {
	...
	function z(r, n, t, xt, _t) {
		...
		if (dt(r)) {
			...
			return (
				...
				(St.getElements = function (n) {
					var t = { target: or, host: ar, padding: fr, viewport: cr, content: sr, scrollbarHorizontal: { scrollbar: f[0], track: s[0], handle: l[0] }, scrollbarVertical: { scrollbar: v[0], track: b[0], handle: y[0] }, scrollbarCorner: ir[0] };
					...
					(function wt(n, t, r) {
						...
						return (
							...
							zt.x && zt.y && !qt.nativeScrollbarsOverlaid.initialize
								? ((Rt = !0), ti("onInitializationWithdrawn"), p && (at(!0), ft(!0), st(!0)), ($t = Lt = !(Rt = !1)))
								: (Wt &&
		...
		function Ue() {
			h && !qr && (S.observe(ar, { attributes: !0, attributeOldValue: !0, attributeFilter: Bn }), z.observe(Nt ? or : sr, { attributes: !0, attributeOldValue: !0, subtree: !Nt, childList: !Nt, characterData: !Nt, attributeFilter: Nt ? qn : Bn }), (qr = !0));
		}
		function Ve() {
			...
			if ((u && (Xt = setTimeout(Xe, Fe)), !(Lt || u || ($t && !a) || (Rt && !o && (t = Kt.is(":hidden"))) || "inline" === Kt.css("display")))) {
				...
				if (((Pr = wn), an && (un || T || X || Y.c || cn.c) ? (ln[pe] = me) : (un || T) && (ln[pe] = we), rn && (en || T || X || Y.c || cn.c || q) ? ((ln[he] = me), (vn[de + he] = we)) : (en || T) && ((ln[he] = we), (ln[be] = ye), (vn[de + he] = ye)), rn ? ((vn[he] = me), (ln[he] = _i.v(he, "max-content intrinsic") || me), (ln[be] = G)) : (vn[he] = ye), (vn[pe] = an ? _n.h || sr[xi.cH] : ye), C && rr.css(vn), nr.css(ln), (ln = {}), (vn = {}), e || i || xn || q || X || T || en || rn || un || an || R || D || k || S || d || p || g || y || E || j || V)) {
					...
					if (
						...
						nt(!1),
						!Ct && (ee.h < ie.x || ee.w < ie.y) && ((qn.x && Bn.x && !zt.x) || (qn.y && Bn.y && !zt.y)) ? ((tt[ae + fe] = ie.x), (tt[oe + fe] = -ie.x), (tt[ae + G] = ie.y), (tt[oe + G] = -ie.y)) : (tt[ae + fe] = tt[oe + fe] = tt[ae + G] = tt[oe + G] = ye),
						(tt[ae + K] = tt[oe + K] = ye),
